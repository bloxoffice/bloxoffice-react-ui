...
app.use("/", express.static(path.join(__dirname, "../static_pages/home")));
app.use("/register/success", express.static(path.join(__dirname, "../static_pages/registerSuccess")));
app.use("/passwordlink/success", express.static(path.join(__dirname, "../static_pages/resetLinkSentSuccess")));
app.use("/resetPassword/success", express.static(path.join(__dirname, "../static_pages/resetPasswordSuccess")));
app.use("/submitemail", express.static(path.join(__dirname, "../static_pages/submitemail")));
app.use("/submitemailsuccess", express.static(path.join(__dirname, "../static_pages/sentemailsuccess")));

app.get("/about", function (req, res) {
  res.sendFile(path.join(__dirname, "../static_pages/about/about.html"));
});

app.get('/login', renderServerSideApp);
